@extends("layout")
@section("content")
    <section class="forgotten-and-recover-password-section padding-top-120 padding-bottom-200 padding-top-xs-50 padding-bottom-xs-50">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <form method="POST" id="recover-password" class="padding-top-80 padding-bottom-80 padding-top-xs-40 padding-bottom-xs-40" action="{{route('password-recover-submit')}}">
                        ...
                        <div>
                            <input type="submit" value="RESET PASSWORD" class="white-light-blue-btn"/>
